...
- (void)setLive:(YZLiveItem *)live
{
    ...
    self.chaoyangLabel.textColor = [UIColor lightGrayColor];
    // 设置当前观众数量
    NSString *fullChaoyang = [NSString stringWithFormat:@"%zd\n在看", live.online_users];
    ...
    self.chaoyangLabel.numberOfLines = 0;
}
