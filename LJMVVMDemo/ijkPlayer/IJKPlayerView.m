...
//工具蒙版
@property (nonatomic,strong)AnimationButton * btnOperate;
@property (nonatomic,strong)AnimationButton * btnLock;
@property (nonatomic,strong)ZSLoading * loading;

//标题栏
@property (nonatomic,strong)AnimationButton * btnBack;
@property (nonatomic,strong)UILabel * lblTitle;

//工具蒙版
@property (nonatomic,strong)AnimationButton *btnPlay;
@property (nonatomic,strong)AnimationButton *btnFullScreen;
...
-(void)setupPlayerView{
    ...
    //返回按钮
    _btnBack = [[AnimationButton alloc]init];
    ...
    //全屏按钮
    _btnFullScreen = [[AnimationButton alloc]init];
    ...
    //播放按钮
    _btnPlay = [[AnimationButton alloc]init];
    ...
    _btnLock = [[AnimationButton alloc]init];
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    if ([touch.view isKindOfClass:[AnimationButton class]]){
        return NO;
    }
    return YES;
}
...
#pragma mark-锁定
-(void)lock:(AnimationButton *)sender{
...
-(void)play:(AnimationButton *)sender{
...
- (void)fullScreen:(AnimationButton *)sender {
